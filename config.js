...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || '𝐐𝐀𝐈𝐃𝐈 𝐍𝐎 804;𝐐𝐀𝐈𝐃𝐈 𝐍𝐎 804;923074060856;https://i.imgur.com/P7ziVhr.jpeg;https://whatsapp.com/channel/0029Va8ymxS0QeabB7oATM3r',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "𝐐𝐀𝐈𝐃𝐈 𝐍𝐎 804",
    BOT_NAME: process.env.BOT_NAME || '𝐐𝐀𝐈𝐃𝐈 𝐍𝐎 804',
